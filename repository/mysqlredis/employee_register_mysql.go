...
// RepositoryEmployeeRegister contains clients and EmployeeRegister repositories
type RepositoryEmployeeRegister struct {
	Clients *clients.Clients
}

// CreateEmployeeRegister is used to create employee_register
func (r RepositoryEmployeeRegister) CreateEmployeeRegister(dbtx common.DBTx, er entity.EmployeeRegister) (*entity.EmployeeRegister, error) {
	...
	if err != nil {
		...
		}).Errorln("[RepositoryEmployeeRegister][CreateEmployeeRegister]: ", err.Error())
		return nil, err
	}
...
func (r RepositoryEmployeeRegister) IsEmployeeRegisterExist(dbtx common.DBTx, employeeID int, otpCode string) (bool, error) {
	...
	if err != nil {
		log.WithFields(log.Fields{
			...
			"time":       timeNow,
		}).Errorln("[RepositoryEmployeeRegister][IsEmployeeRegisterExist]: ", err.Error())
		return false, err
	}
