...
func (s *ServiceAuth) Register(ri RegisterInput) (int, error) {
	// // TODO: validate input
	...
	// 	}).Errorln("[ServiceAuthRegister][Register][Begin]: ", err.Error())
	...
	// 	}).Errorln("[ServiceAuthRegister][Register][CreateCompany]: ", err.Error())
	// 	return http.StatusInternalServerError, err
	// }
	...
	// 		"rollback":      tx.Rollback(),
	// 	}).Errorln("[ServiceAuthRegister][Register][CreateRole]: ", err.Error())
	// 	return http.StatusInternalServerError, err
	// }
	...
	// 		"rollback":      tx.Rollback(),
	// 	}).Errorln("[ServiceAuthRegister][Register][CreateEmployee]: ", err.Error())
	// 	return http.StatusInternalServerError, err
	// }
	...
	// 		"rollback":      tx.Rollback(),
	// 	}).Errorln("[ServiceAuthRegister][Register][UpdateEmployeePassword]: ", err.Error())
	// 	return http.StatusInternalServerError, err
	// }
	...
	// 		"role":          fmt.Sprintf("%+v", role),
	// 		"employee":      fmt.Sprintf("%+v", employee),
	// 	}).Errorln("[ServiceAuthRegister][Register][OTP6]emailOTP: ", err.Error())
	// 	return 0, err
	// }
	...
	// 		"role":          fmt.Sprintf("%+v", role),
	// 		"employee":      fmt.Sprintf("%+v", employee),
	// 	}).Errorln("[ServiceAuthRegister][Register][Commit]: ", err.Error())
	// 	return http.StatusInternalServerError, err
	// }
...
func (s *ServiceAuth) Verify(vi VerifyInput) (int, error) {
	// // TODO: validate input
	// // TODO: change to informative error in user
	...
	// 	}).Errorln("[ServiceAuthRegister][Verify][IsEmployeeRegisterExist]: ", err.Error())
	// 	return http.StatusInternalServerError, err
	// }
	// if !isEmployeeRegisterExist {
	// 	log.WithFields(log.Fields{
	// 		"verifyInput": fmt.Sprintf("%+v", vi),
	// 	}).Errorln("[ServiceAuthRegister][Verify][IsEmployeeRegisterExist]: wrong otp code")
